                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            @php
                                                $avatarPath = $user->avatar ? Storage::url($user->avatar) : asset('avatar/default.jpeg');
                                            @endphp
                                            <img src="{{ $avatarPath }}" alt="Avatar" class="img-fluid rounded mb-2" width="100%">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            @php
                                                $address = $address ?? new \App\Models\UserAddress();
                                            @endphp
                                            @foreach (['country' => 'Quốc gia', 'city' => 'Thành phố', 'district' => 'Quận', 'ward' => 'Phường', 'specific_address' => 'Địa chỉ chi tiết'] as $field => $label)
                                                <div class="mb-3 col-6">
                                                    ...
                                                    <input value="{{ old($field, $address->$field ?? '') }}" name="{{ $field }}"
