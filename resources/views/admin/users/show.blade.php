                        ...
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Thông tin
                                        tài khoản</a></li>
                                <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Cập nhật mật
                                        khẩu</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Chỉnh sửa thông
                                        tin</a>
                                </li>
                            </ul>
                        </div><!-- /.card-header -->
