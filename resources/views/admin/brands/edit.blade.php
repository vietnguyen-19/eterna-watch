...
@section('content')
    <div class="col-lg-12">
        <div class="card" id="customerList">
            ...
            <form action="{{ route('admin.brands.update', $brand->id) }}" autocomplete="off" method="POST"
                ...
                <div class="card-footer">
                    <div class="hstack gap-2 justify-content-left">
                        <button type="submit" class="btn btn-success" id="add-btn">Cập nhật thương hiệu</button>
