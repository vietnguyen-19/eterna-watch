...
@section('content')
    <div class="col-lg-12">
        <div class="card" id="customerList">
            ...
            <form action="{{ route('admin.settings.update', $setting->id) }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    <div class="body row">
                        <div class="mb-3 col-12">
                            ...
                            <input name="key" value="{{ old('key', $setting->key) }}" type="text" id="key"
...
@section('script')
    {{-- Không cần JS tạo slug ở đây vì không có trường 'name' hay 'slug' --}}
@endsection
