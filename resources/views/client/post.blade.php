            ...
            <div class="shop-list flex-grow-1">
                <div class="products-grid row" id="products-grid">
                    <section class="blog-page blog-single container">
                        <div class="mw-930 text-left">
                            <h2 class="page-title">5 Tips to Increase Your Online Sales</h2>
                            <div class="blog-single__item-meta">
                                <span class="blog-single__item-meta__author">By Admin</span>
                                <span class="blog-single__item-meta__date">Aprial 05, 2023</span>
                                <span class="blog-single__item-meta__category">Trends</span>
                            </div>
                        </div>
                        <div class="blog-single__item-content">
                            <p>
                                <img loading="lazy" class="w-100 h-auto d-block" src="{{ asset('theme/client/images/blog/blog-14.jpg')}}"
                                    width="1410" height="550" alt="">
                            </p>
                            <div class="mw-930">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet sapien dignissim a
                                    elementum. Sociis
                                    metus, hendrerit mauris id in. Quis sit sit ultrices tincidunt euismod luctus diam.
                                    Turpis sodales
                                    orci etiam phasellus lacus id leo. Amet turpis nunc, nulla massa est viverra interdum.
                                    Praesent
                                    auctor nulla morbi non posuere mattis. Arcu eu id maecenas cras. Eget fames tincidunt
                                    leo, sed
                                    vitae, pretium interdum. Non massa, imperdiet nunc sit sapien. Tempor lectus ornare quis
                                    mi vel.
                                    Nibh euismod donec elit posuere lobortis consequat faucibus aliquam metus. Ornare
                                    consequat,
                                    vulputate sit maecenas mauris urna sed fringilla. Urna fermentum iaculis pharetra,
                                    maecenas dui
                                    nullam nullam rhoncus. Facilisis quis vulputate sem gravida lacus, justo placerat.</p>
                                <h5>Sed do eiusmod tempor incididunt ut labore</h5>
                                <p>Saw wherein fruitful good days image them, midst, waters upon, saw. Seas lights seasons.
                                    Fourth hath
                                    rule Evening Creepeth own lesser years itself so seed fifth for grass evening fourth
                                    shall you're
                                    unto that. Had. Female replenish for yielding so saw all one to yielding grass you'll
                                    air sea it,
                                    open waters subdue, hath. Brought second Made. Be. Under male male, firmament, beast had
                                    light after
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <ul class="list text-list list_dot_darkgray">
                                            <li class="list-item text-list__item">Creat by cotton fibric with soft and
                                                smooth</li>
                                            <li class="list-item text-list__item">Simple, Configurable (e.g. size, color,
                                                etc.),
                                                bundled</li>
                                            <li class="list-item text-list__item">Downloadable/Digital Products, Virtual
                                                Products</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <ol class="list text-list">
                                            <li class="list-item text-list__item">Create Store-specific attrittbutes on the
                                                fly</li>
                                            <li class="list-item text-list__item">Simple, Configurable (e.g. size, color,
                                                etc.),
                                                bundled</li>
                                ...
                                <p>She'd years darkness days. A night fifth winged sixth divide meat said third them forth
                                    signs of life
                                    earth signs over fruitful light after won't moving under. Thing yielding upon seed.
                                    Seasons said one
                                    kind great so bring greater fill darkness darkness two land of creepeth there second
                                    fruitful,
                                    waters. Make don't void years Gathering gathering divide fill.</p>
                            </div>
                            <div class="container mw-1170">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><img loading="lazy" class="w-100 h-auto d-block"
                                                src="{{ asset('theme/client/images/blog/blog-15.jpg')}}" width="570" height="697"
                                                alt=""></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><img loading="lazy" class="w-100 h-auto d-block"
                                                src="{{ asset('theme/client/images/blog/blog-16.jpg')}}" width="570" height="697"
                                                alt=""></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="blog-single__item-share mw-930">
                            <a href="http://www.facebook.com/sharer.php?u=https://uomo-crystal.myshopify.com/blogs/news/go-to-wellness-tips-for-mental-health"
                            ...
                            <a href="http://twitter.com/share?text=Go-to%20Wellness%20Tips%20for%20Mental%20Health&amp;url=https://uomo-crystal.myshopify.com/blogs/news/go-to-wellness-tips-for-mental-health"
                        ...
                        <div class="blog-single__item-pagination mw-930">
                            <div class="row">
                                <div class="col-lg-6">
                            ...
                            <div class="blog-single__reviews-list">
                                <div class="blog-single__reviews-item">
                                    <div class="customer-avatar">
                                        <img loading="lazy" src="{{ asset('theme/client/images/avatar.jpg')}}" alt="">
                                    </div>
