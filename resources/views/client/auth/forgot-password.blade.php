            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" name="email" id="email" class="form-control" placeholder="example@gmail.com" value="{{ old('email') }}">
                    ...
                    <button type="submit" class="btn btn-primary w-100 text-uppercase">Gửi link đặt lại mật khẩu</button>
