                                ...
                                <table class="checkout-cart-items">
                                    <thead class="table-dark">
                                        <tr>
                                            ...
                                            <th class="text-dark fw-bold" class="fw-bold text-center" scope="col">Giá
                                            </th>
                                            <th class="text-dark fw-bold" scope="col">Số lượng muốn hoàn</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="refund_quantity[{{ $item->id }}]"
                                                        ...
                                                        max="{{ $item->quantity }}" value="0" required>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
