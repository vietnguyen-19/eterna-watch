...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                $imagePath = ImageHandler::saveImage($request->file('image'), 'categories');
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                $category->image = ImageHandler::updateImage($request->file('image'), $category->image, 'categories');
            }
    ...
    public function forceDelete($id)
    {
        try {
            ...
            if ($category->parent_id === null) {
                ...
                if ($category->image) {
                    ImageHandler::deleteImage($category->image);
                }
            }
